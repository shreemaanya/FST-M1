package liveProject;
import liveProject.ActionsBase;
...
public class Activity2 {
	...
	public void tasksTest2() {
		...
		Point start = new Point((int) (dims.getWidth() * .42), (int) (dims.getHeight() * .16));
		
		// Perform long press on the first list item
		ActionsBase.doLongPress(driver, start);
		// Select edit task
		...
		driver.findElement(AppiumBy.xpath("//android.view.View[@content-desc=\"07 September 2025\"]")).click();
		// Save details
		...
		Assert.assertEquals(expectedDeadline, "Deadline: 07.09.2025");
	}
