...
public class Activity4 {
    ...
    public void contactsTest() {
        ...
        driver.findElement(AppiumBy.xpath("//android.widget.TextView[@text=\"Create contact\"]")).click();
        
        //accessibilityId("Create contact")
        ...
        driver.findElement(AppiumBy.xpath(
                "//android.widget.EditText[@text=\"+91\"]")).sendKeys("9999148292");
        // Click Save
